...
function Products() {
    ...
    return <>
        ...
        <div className="flex flex-row justify-start items-start flex-wrap gap-x-9 gap-y-8 cursor-pointer mx-20">
            <div className="border-2 rounded-3xl p-1 border-[rgb(201, 197, 197)] pb-2">
                ...
                <div className="px-1 mt-4 mx-1 flex justify-between items-center">
                    <span className="border-2 p-2 border-[rgb(201, 197, 197)] pb-2 rounded-2xl hover:bg-gray-400">
                        Add to Cart
                    </span>
